...
export const COURSE_DETAILS_REQUEST = "COURSE_DETAIL_REQUEST";
export const COURSE_DETAILS_SUCCESS = "COURSE_DETAIL_SUCCESS";
export const COURSE_DETAILS_FAIL = "COURSE_DETAIL_FAIL";
